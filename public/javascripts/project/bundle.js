...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./polyfill */ \"./src/project/polyfill.js\");\n/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./app */ \"./src/project/app.js\");\n/* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./loader */ \"./src/project/loader.js\");\n/* harmony import */ var _snapshotList__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./snapshotList */ \"./src/project/snapshotList.js\");\n/* harmony import */ var _navigation_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../navigation.js */ \"./src/navigation.js\");\n\n\n\n\n // must refactor asap\n\nvar navigation = new _navigation_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"]({\n  element: document.querySelector('.navigation'),\n  header: document.querySelector('header'),\n  isMobile: window.matchMedia('only screen and (max-width: 425px)').matches\n});\nvar loader = new _loader__WEBPACK_IMPORTED_MODULE_2__[\"default\"]({\n  wait: 200\n});\nvar snapshotList = new _snapshotList__WEBPACK_IMPORTED_MODULE_3__[\"default\"]();\nvar app = new _app__WEBPACK_IMPORTED_MODULE_1__[\"default\"](loader, snapshotList, {\n  limit: 4\n});\nwindow.addEventListener('DOMContentLoaded', function () {\n  app.addSnapshots();\n});\n\n//# sourceURL=webpack:///./src/project/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Loader; });\n/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers */ \"./src/project/helpers.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar Loader = /*#__PURE__*/function () {\n  function Loader() {\n    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},\n        wait = _ref.wait;\n\n    _classCallCheck(this, Loader);\n\n    this.wait = wait;\n    this.$loader = document.querySelector('.loader');\n    this.throttledHandler = null;\n    this.load = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__[\"raf\"])(this.load.bind(this));\n  }\n  /**\n   * @returns {Element}\n   */\n\n\n  _createClass(Loader, [{\n    key: \"getElement\",\n    value: function getElement() {\n      return this.$loader;\n    }\n    /**\n     * Adds event handelr\n     * @param {Function()} handler \n     */\n\n  }, {\n    key: \"on\",\n    value: function on(handler) {\n      var _this = this;\n\n      this.throttledHandler = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__[\"throttle\"])(function () {\n        handler();\n\n        _this.getElement().classList.remove('loader--loading');\n      }, this.wait);\n      window.addEventListener('scroll', this.load);\n    }\n    /**\n     * Stops to trigger event\n     */\n\n  }, {\n    key: \"off\",\n    value: function off() {\n      window.removeEventListener('scroll', this.load);\n      this.getElement().classList.add('loader--stop');\n    }\n  }, {\n    key: \"load\",\n    value: function load() {\n      if (!this.isVisible()) return;\n      this.getElement().classList.add('loader--loading');\n      this.throttledHandler();\n    }\n  }, {\n    key: \"isVisible\",\n    value: function isVisible() {\n      var viewportHeight = window.innerHeight || document.documentElement.clientHeight;\n\n      var _this$getElement$getB = this.getElement().getBoundingClientRect(),\n          targetTop = _this$getElement$getB.top,\n          targetBottom = _this$getElement$getB.bottom;\n\n      return targetBottom > 0 && targetTop < viewportHeight;\n    }\n  }]);\n\n  return Loader;\n}();\n\n\n\n//# sourceURL=webpack:///./src/project/loader.js?");

/***/ }),

/***/ "./src/project/polyfill.js":
/*!*********************************!*\
  !*** ./src/project/polyfill.js ***!
  \*********************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Snapshot; });\n/* harmony import */ var _template__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./template */ \"./src/project/template.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar Snapshot = /*#__PURE__*/function () {\n  /**\n   * @param {Object} snapshot\n   * @param {String} snapshot.imageUrl\n   */\n  function Snapshot(_ref) {\n    var imageUrl = _ref.imageUrl;\n\n    _classCallCheck(this, Snapshot);\n\n    this.imageUrl = imageUrl;\n  }\n  /**\n   * @param {Element} parent \n   */\n\n\n  _createClass(Snapshot, [{\n    key: \"render\",\n    value: function render(parent) {\n      var snapshotColumn = Number(parent.dataset.column);\n      var widthRatio = 100 / snapshotColumn;\n      var snapshot = Object.assign({}, this, {\n        widthRatio: widthRatio\n      });\n      parent.insertAdjacentHTML('beforeend', Object(_template__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(snapshot));\n    }\n  }]);\n\n  return Snapshot;\n}();\n\n\n\n//# sourceURL=webpack:///./src/project/snapshot.js?");

/***/ }),

/***/ "./src/project/snapshotList.js":
/*!*************************************!*\
  !*** ./src/project/snapshotList.js ***!
  \*************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return SnapshotList; });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar SnapshotList = /*#__PURE__*/function () {\n  function SnapshotList() {\n    _classCallCheck(this, SnapshotList);\n\n    this.$snapshotList = document.querySelector('section');\n  }\n  /**\n   * @returns {Element}\n   */\n\n\n  _createClass(SnapshotList, [{\n    key: \"getElement\",\n    value: function getElement() {\n      return this.$snapshotList;\n    }\n    /**\n     * @param {Snapshot[]} snapshots \n     */\n\n  }, {\n    key: \"add\",\n    value: function add(snapshots) {\n      var $snapshotList = this.getElement();\n      snapshots.forEach(function (snapshot) {\n        return snapshot.render($snapshotList);\n      });\n    }\n  }]);\n\n  return SnapshotList;\n}();\n\n\n\n//# sourceURL=webpack:///./src/project/snapshotList.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (function (_ref) {\n  var title = _ref.title,\n      imageUrl = _ref.imageUrl,\n      widthRatio = _ref.widthRatio;\n  return \"<img class=\\\"snapshot\\\" style=\\\"width: \".concat(widthRatio, \"%\\\" src=\\\"\").concat(imageUrl, \"\\\" alt=\\\"\").concat(title, \"\\\">\");\n});\n;\n\n//# sourceURL=webpack:///./src/project/template.js?");
